...
public class Promocao{
    ...
    public Promocao(){
        ...
        this.descricao_promocao = "";
        this.data_final = "";
    }

    public Promocao(Categoria categoria, String nome, String marca, String id_prod, double preco, int quant_em_arm, int tier_saudavel, int tier_dieta, int tier_familiar, int tier_marca, int tier_sustentavel, String descricao_promocao, String data_final) {
    ...
    public Promocao(Promocao a){
        ...
        this.descricao_promocao = a.get_descricao_promocao();
        this.data_final = a.get_data_final();
    ...
    public String get_descricao_promocao() {
    ...
    public void set_descricao_promocao(String descricao_promocao) {
        this.descricao_promocao = descricao_promocao;
    }

    public void set_data_final(String data_final) {
        this.data_final = data_final;
    }

    //funcoes uteis
    
    public Promocao clone(Promocao a){
        return new Promocao(a);
    }
    ...
    public boolean equals(Object o){
        ...
        return (this.categoria.equals(p.get_categoria()) && this.nome.equals(p.get_nome()) && this.marca.equals(p.get_marca()) && 
                ...
                this.tier_marca == p.get_tier_marca() && this.tier_sustentavel == p.get_tier_sustentavel() && this.descricao_promocao.equals(p.get_descricao_promocao()) &&
                this.data_final.equals(p.get_data_final()));
    }

    public Promocao clone(){
        return new Promocao(this);
    }
}